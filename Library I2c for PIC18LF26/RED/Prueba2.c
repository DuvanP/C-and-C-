...
// ESTE CODIGO FUNCIONA CON 5 NODOS de reconocimiento maximo, depende del arreglo que se use.
...
unsigned char NODO1[8] = 0;
unsigned char NODO2[8] = 0;
unsigned char NODO3[8] = 0;
unsigned char NODO4[8] = 0;
